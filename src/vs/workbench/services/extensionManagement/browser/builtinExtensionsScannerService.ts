			...
			if (builtinExtensionsServiceUrl) {
				...
				if (environmentService.isBuilt) {
					...
					bundledExtensions = [
						...
						{
							"extensionPath": "configuration-editing",
							"packageJSON": {
						...
						{
							"extensionPath": "css-language-features",
							"packageJSON": {
							...
							"readmePath": "css-language-features/README.md"
						},
						{
							"extensionPath": "dart",
							"packageJSON": {
						...
						},
						{
							...
							"readmePath": "media-preview/README.md"
						},
						{
						...
						{
							"extensionPath": "mermaid-chat-features",
							"packageJSON": {
							...
							"readmePath": "mermaid-chat-features/README.md"
						},
						{
							"extensionPath": "notebook-renderers",
							"packageJSON": {
							...
							"readmePath": "notebook-renderers/README.md"
						},
						{
							"extensionPath": "npm",
							"packageJSON": {
						...
						},
						{
							...
							"readmePath": "references-view/README.md"
						},
						{
							"extensionPath": "restructuredtext",
							"packageJSON": {
						...
						},
						{
							...
							"packageNLS": {
								...
								"configuration.referencesCodeLens.showOnAllFunctions": "Enable/disable the [references CodeLens](#js/ts.referencesCodeLens.enabled) on all functions in JavaScript and TypeScript files.",
								...
								"configuration.implementationsCodeLens.enabled": "Enable/disable implementations CodeLens in TypeScript files. This CodeLens shows the implementers of TypeScript interfaces.",
								...
								"configuration.implementationsCodeLens.showOnInterfaceMethods": "Enable/disable [implementations CodeLens](#js/ts.implementationsCodeLens.enabled) on TypeScript interface methods.",
								...
								"configuration.implementationsCodeLens.showOnAllClassMethods": "Enable/disable showing [implementations CodeLens](#js/ts.implementationsCodeLens.enabled) above all TypeScript class methods instead of only on abstract methods.",
								...
								"configuration.suggest.jsdoc.enabled": "Enable/disable suggestion to complete JSDoc comments.",
						...
						{
							"extensionPath": "vscode-test-resolver",
							"packageJSON": {
						...
						},
						{
							...
							"packageJSON": {
								...
								"repository": {
									...
									"directory": "node/vscode_extension"
								},
								"engines": {
									"vscode": "^1.70.0"
								},
									...
									"configuration": {
										...
										"properties": {
											...
											"kimi.executablePath": {
												"type": "string",
												"default": "",
												"description": "Path to the Kimi Code executable (leave empty to use bundled CLI)"
											},
											...
											"kimi.environmentVariables": {
												"type": "object",
												"default": {},
												"description": "Environment variables passed to the Kimi Code CLI",
												"additionalProperties": {
													"type": "string"
												}
											},
								...
								"scripts": {
									...
									"build:webview": "pnpm --filter @moonshot-ai/vscode_extension-webview-ui build",
